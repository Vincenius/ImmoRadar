...
const main = async () => {
  ...
  for (const table of tables.flat()) {
    const url = `${NOCODB_URI}/api/v2/tables/${table.id}/records?limit=1000`
    const options = getOptions()
