  ...
  return (
    ...
    >
          ...
          <Flex gap="xl" direction="column" justify="center" align={{ base: 'center', md: 'start' }}>
            <Box my={{ base: '4em', sm: '8em' }}>
              ...
              <Title order={2} size="h4" mb="3em" fw="normal" w="70%">
                Mit dem kostenlosen Förderreport findest Du in 30 Sekunden die besten Förderungen für Dein Bauvorhaben - bundesweit, regional & individuell.
              </Title>
              <ButtonMultiLine component={Link} href="/foerdercheck" size="xl" p="md" leftSection={<IconCheckbox size={24} />}>
                Jetzt direkt prüfen
              </ButtonMultiLine>
              <Text>(kostenlos und unverbindlich)</Text>
            </Box>
          </Flex>
        </Flex>
      </Box>
      ...
      <Box py="8em" pos="relative">
        <Title order={2} ta="center" mb="xl" textWrap='balance'>Einfach erfolgreich: So profitieren unsere Kunden von Ihrem persönlichen Förderreport</Title>
