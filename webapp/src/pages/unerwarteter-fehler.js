...
const EmailBestaetigt = () => {
    return (
        <Layout title="Unerwarteter Fehler | ImmoRadar" description="E-Mail Addresse konnte nicht bestätigt werden.">
            ...
            <Text>Kontakt: <a href="mailto:vincent.will@immoradar.xyz">vincent.will@immoradar.xyz</a></Text>
        </Layout>
    );
};
