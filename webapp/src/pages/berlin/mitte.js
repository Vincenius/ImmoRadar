...
export default function Home() {
  return (
    <CityLayout
      title="Wohnungen in Berlin Mitte - Leben im Zentrum von Berlin | ImmoRadar"
    ...
    >
      <Text mb="lg">
        ...
        Mit ImmoRadar wird deine Suche nach einer Wohnung in Berlin Mitte zum Kinderspiel.
      </Text>
      ...
      >
        ...
        <List.Item mb="sm">
          ...
          ein Pärchen oder eine geräumige <Link href="/search?q=Berlin-Mitte&page=1&minRooms=5&maxRooms=5">Fünf-Zimmer-Wohnung</Link> für die ganze Familie suchst.        </List.Item>
        <List.Item mb="sm">
