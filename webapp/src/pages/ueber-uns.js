    ...
    return (
        ...
        >
            <Container py="xl" size="sm">
                ...
                <Text my="md">
                    <a href="mailto:oliver.rausch@fertighausradar.de">oliver.rausch@fertighausradar.de</a><br/>
                    <a href="mailto:vincent.will@fertighausradar.de">vincent.will@fertighausradar.de</a><br/>
                </Text>
            </Container>
        </Layout>
    );
