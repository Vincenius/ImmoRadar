...
export default async function handler(req, res) {
  if (req.method === 'POST') {
    try {
      ...
      const newLead = await fetch('https://admin.fertighausradar.de/api/v2/tables/ml7dpwwbdlxn92i/records', options)
        .then(res => res.json())

      const url = `https://admin.fertighausradar.de/api/v2/tables/${tableIds[type]}/records`
      ...
      await fetch(`https://admin.fertighausradar.de/api/v2/tables/ml7dpwwbdlxn92i/links/${linkId}/records/${newLead.Id}`, linkOptions)
