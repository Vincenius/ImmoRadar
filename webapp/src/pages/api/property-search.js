    ...
    if (req.method === 'GET') {
        ...
        try {
            const {
                ...
                titleIncludes, titleExcludes, providers = '',
                page = 1, limit = 20
            } = req.query;
            ...
            if (!q) {
                ...
                if (minSize && !isNaN(parseInt(minSize))) {
                    sizeFilter['size'] = { $gte: parseInt(minSize) };
                }
                if (maxSize && !isNaN(parseInt(maxSize))) {
                    sizeFilter['size'] = { ...sizeFilter['size'], $lte: parseInt(maxSize) };
                }
                ...
                const filter = [priceFilter, sizeFilter, titleFilter, providerFilter]
