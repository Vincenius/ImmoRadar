...
import { Flex, Group, Button, Title, Box, Stepper, Modal, RangeSlider, Card, Chip } from '@mantine/core';
...
function Vergleich() {
  ...
  return (
    <Layout title="Fertighausanbieter Vergleich" description="todo">
      <Card my="3em" withBorder mb="xl" shadow="md">
        <Stepper
          active={active}
