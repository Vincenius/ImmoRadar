    ...
    <mj-body>
      ...
      <mj-section background-color="#f3f3f3">
        <mj-column>
          ...
          <mj-text font-size="15px" color="#000" font-family="helvetica">vielen Dank für deine Anmeldung bei Fertighaus Radar!</mj-text>
          ...
          <mj-text font-size="15px" color="#000" font-family="helvetica">Vielen Dank für dein Vertrauen in Fertighaus Radar! Wir freuen uns darauf, dir die besten Angebote für Wohnungen in deiner gewünschten Region zu senden.</mj-text>
          ...
          <mj-text font-size="15px" color="#000" font-family="helvetica">Vincent von Fertighaus Radar</mj-text>
        </mj-column>
      </mj-section>
    </mj-body>
  </mjml>`).html
