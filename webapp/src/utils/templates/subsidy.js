  ...
  <mj-body>
    ...
    <mj-section background-color="#f3f3f3">
      <mj-column>
        ...
        <mj-text font-size="15px" color="#000" font-family="helvetica">Vielen Dank für dein Vertrauen in ImmoRadar!</mj-text>
        ...
        <mj-text font-size="15px" color="#000" font-family="helvetica">Falls du Fragen hast oder Feedback geben möchtest, erreichst du mich jederzeit unter <a href="mailto:vincent@immoradar.xyz">vincent@immoradar.xyz</a>.</mj-text>
