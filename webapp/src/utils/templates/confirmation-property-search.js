    ...
    <mj-body>
      ...
      <mj-section background-color="#f3f3f3">
        <mj-column>
          ...
          <mj-text font-size="15px" color="#000" font-family="helvetica">Um Ihre Anmeldung abzuschließen und sicherzustellen, dass wir Sie mit den besten Grundstücksvorschlägen versorgen können, bitten wir Sie, Ihre E-Mail-Adresse zu bestätigen. Klicken Sie dazu einfach auf den folgenden Link:</mj-text>
          ...
          <mj-text font-size="15px" color="#000" font-family="helvetica">Nach der Bestätigung erhalten Sie bald die ersten Vorschläge zu Grundstücken, die perfekt auf Ihre Wünsche abgestimmt sind.</mj-text>
