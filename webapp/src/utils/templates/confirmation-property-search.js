    ...
    <mj-body>
      ...
      <mj-section background-color="#f3f3f3">
        <mj-column>
          ...
          <mj-text font-size="15px" color="#000" font-family="helvetica"><b>Was Sie erwartet:</b></mj-text>
  
          <mj-text font-size="15px" color="#000" font-family="helvetica">Nach der Bestätigung erhalten Sie schon bald Vorschläge, die perfekt zu Ihren Wünschen passen.</mj-text>
          
          <mj-text font-size="15px" color="#000" font-family="helvetica"><b>Unser Versprechen:</b></mj-text>
  
          <mj-text font-size="15px" color="#000" font-family="helvetica">Wir begleiten Sie von der Suche bis zum Finden - effizient, einfach und genau auf Ihre Bedürfnisse zugeschnitten.</mj-text>
